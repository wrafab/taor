...
This robot will drive around on its own and reacto obstacles by backing up and turning to a new direction.

This sketch was adapted from one of the actvities in the Sparkfun Guide to Arduino.
